        ...
        >
          <GridListTile className={classes.imageContainer}>
            <span onClick={() => handleOpenModal(0)} style={{ padding: 5 }}>
              <img style={imgStyles} src={screenshots[0]} alt="screenshot" />
            </span>
          </GridListTile>
          ...
          {screenshots[1] && (
            <GridListTile className={classes.imageContainer}>
              <span onClick={() => handleOpenModal(1)} style={{ padding: 5 }}>
                <img style={imgStyles} src={screenshots[1]} alt="screenshot" />
              </span>
            </GridListTile>
          )}
          ...
          {screenshots[1] && (
            <GridListTile className={classes.imageContainer}>
              <span onClick={() => handleOpenModal(2)} style={{ padding: 5 }}>
                <img style={imgStyles} src={screenshots[2]} alt="screenshot" />
              </span>
            </GridListTile>
          )}
        </GridList>
