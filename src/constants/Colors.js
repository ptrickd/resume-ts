export const btnPrimary = '#0069D9';
// export const btnPrimary = '#0069D9';
export const btnDanger = '#'

export const backgroundDark = '#0B2B53';
export const navBgDark = '#464646';
export const fontColorDark = '#DADADA';
...
export const colorAboutLight = 'black';
export const contactFormBgLight = '#e8eced';